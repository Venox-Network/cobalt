...
def cog_creator(servers: List[int]):
    class React(BaseCog):
        ...
        @BaseCog.cslash_command(description="Mass react to messages", guild_ids=servers)
        async def react(self, ctx: ApplicationContext, emojis: Option(str), message_id: Option(str)):
        ...
        @BaseCog.cslash_command(description='Makes bot react to all messages in certain channels', guild_ids=servers)
        ...
        @BaseCog.cslash_command(description="Removes static react channel", guild_ids=servers)
        ...
        @BaseCog.cslash_command(description='Sets up or removes channel to react to every emoji in messages', guild_ids=servers)
