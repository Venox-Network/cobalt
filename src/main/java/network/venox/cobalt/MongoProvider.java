...
public class MongoProvider {
    ...
    public MongoProvider(@NotNull LazyLibrary library) {
        ...
        database = new SingleMongo(url).database.loadMagicCollections(MapGenerator.HASH_MAP.mapOf(
                List.of("auto_slowmodes", "auto_threads", "corners", "corner_creators", "users", "limited_messages", "locks", "react_channels", "servers", "sticky_messages", "surveys", "thread_messages"),
                List.of(AutoSlowmode.class, AutoThread.class, Corner.class, CornerCreator.class, CoUser.class, LimitedMessages.class, Lock.class, ReactChannel.class, Server.class, StickyMessage.class, Survey.class, ThreadMessage.class)));
    }
}
