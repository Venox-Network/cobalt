...
@Command
public class ThreadIgnoredAdd {
    @NotNull private final MongoProvider mongo;

    public ThreadIgnoredAdd(@NotNull MongoProvider mongo) {
        this.mongo = mongo;
    }
    ...
    public void threadIgnoredAdd(@NotNull GuildSlashEvent event,
                                 @SlashOption(description = "The channel to add the ignored phrase/role to") @ChannelTypes({ChannelType.TEXT, ChannelType.NEWS}) @Nullable GuildChannel channel,
                                 @SlashOption(description = "The phrase to add to the ignored list") @Nullable String phrase,
                                 @SlashOption(description = "The role to add to the ignored list") @Nullable Role role) {
